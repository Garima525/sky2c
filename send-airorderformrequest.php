...
if ($rq != "" && $shipper_name != "") {
    ...
    $pickup_request_boxes_quantity = serialize(
        $_REQUEST["pickup_request_boxes_quantity"]
    );
    $pickup_request_dimension = serialize(
        $_REQUEST["pickup_request_dimension"]
    );
    ...
    $main_tr =
        "<tr><th>Sr. No.</th><th>Pallet/Boxes Qty</th><th>Dimensions</th><th>Weight LBS/KG</th></tr>";
    ...
    $admin_html_body =
    '<html><body><table width="100%" border="0" cellspacing="0" cellpadding="10" style="background-color:#D6D6D6;">
	  <tr style="background-color:#005E5E; color:#FFF;"><th scope="row" colspan="4" align="center"><h2>Air Order Form Detail</h2></th></tr>
	  ...
	  <tr><th scope="row" align="left">Shipper Name: </th><td>' .
	        $shipper_name .
	        '</td><th scope="row" align="left">Spouse Name: </th><td>' .
	        $spouse_name .
	        '</td></tr>  
	  <tr><th scope="row" colspan="4" align="left"><p>Shipper Address (USA):</p></th></tr>
	  <tr><th scope="row" align="left">Address: </th><td>' .
	        $shipper_usa_address .
	        '</td><th scope="row" align="left">City: </th><td>' .
	        $shipper_usa_city .
	        '</td></tr>
	  <tr><th scope="row" align="left">State: </th><td>' .
	        $shipper_usa_state .
	        '</td><th scope="row" align="left">Zip: </th><td>' .
	        $shipper_usa_zip .
	        '</td></tr>  
	  <tr><th scope="row" colspan="4" align="left"><p>Contact Detail:</p></th></tr>
	  <tr><th scope="row" align="left">Home No: </th><td>' .
	        $contact_home_no .
	        '</td><th scope="row" align="left">Cell#: </th><td>' .
	        $contact_cell .
	        '</td></tr>
	  <tr><th scope="row" align="left">Work (Optional): </th><td>' .
	        $contact_work_no .
	        '</td><th scope="row" align="left">Email: </th><td>' .
	        $contact_email .
	        '</td></tr>  
	  ...
	  <tr><th scope="row" align="left">Consignee Name: </th><td>' .
	        $consignee_name .
	        '</td><th scope="row" align="left">Address: </th><td>' .
	        $consignee_address .
	        '</td></tr>
	  <tr><th scope="row" align="left">City: </th><td>' .
	        $consignee_city .
	        '</td><th scope="row" align="left">Country: </th><td>' .
	        $consignee_country .
	        '</td></tr>
	  <tr><th scope="row" align="left">Tel No: </th><td>' .
	        $consignee_tel_no .
	        '</td><th scope="row" align="left">Email: </th><td>' .
	        $consignee_email .
	        '</td></tr>  
	  ...
	  <tr><th scope="row" align="left">Receiver Name: </th><td>' .
	        $receiver_name .
	        '</td><th scope="row" align="left">Address: </th><td>' .
	        $receiver_address .
	        '</td></tr>
	  ...
	  <tr><th scope="row" align="left">Tel No: </th><td>' .
	        ...
	        $receiver_email .
	        '</td></tr>
	  <tr><th scope="row" align="left">Shipper Signature: </th><td>' .
	        $shipper_sign .
	        '</td><th scope="row" align="left"></th><td></td></tr>
	</table></body></html>';
    ...
    $sql = "Insert into `airorder_form_details` set `a_shipper_name`='$shipper_name', `a_spouse_name`='$spouse_name', `a_shipper_usa_address`='$shipper_usa_address', `a_shipper_usa_city`='$shipper_usa_city', `a_shipper_usa_state`='$shipper_usa_state', `a_shipper_usa_zip`='$shipper_usa_zip', `a_contact_home_no`='$contact_home_no', `a_contact_cell`='$contact_cell', `a_contact_work_no`='$contact_work_no', `a_contact_email`='$contact_email', `a_pickup_address`='$pickup_address', `a_pickup_city`='$pickup_city', `a_pickup_state`='$pickup_state', `a_pickup_zip`='$pickup_zip', `a_pickup_request_srno`='$pickup_request_srno', `a_pickup_request_boxes_quantity`='$pickup_request_boxes_quantity', `a_pickup_request_dimension`='$pickup_request_dimension', `a_pickup_request_weight`='$pickup_request_weight', `a_consignee_name`='$consignee_name', `a_consignee_address`='$consignee_address', `a_consignee_city`='$consignee_city', `a_consignee_country`='$consignee_country', `a_consignee_tel_no`='$consignee_tel_no', `a_consignee_email`='$consignee_email', `a_receiver_name`='$receiver_name',`a_receiver_address`='$receiver_address', `a_receiver_city`='$receiver_city',`a_receiver_country`='$receiver_country', `a_receiver_tel_no`='$receiver_tel_no', `a_receiver_email`='$receiver_email', `a_shipper_sign`='$shipper_sign', `a_regDate`='$today', `a_userIP`='$ip', `a_checkSameAddr`='' ";
    ($insert = mysqli_query($conn, $sql)) or
        die("could not insert data" . mysqli_error($conn));

    $autoresponder =
        '<html><body><table cellspacing=5 cellpadding=5>
	<tr>
    	<td><strong>Hi ' .
        $shipper_name .
        ',</strong></td>
    ...
    <tr>
        <td>Thank you for completing the Air Order Request Form on our website. We have received your inquiry and will reach out to you within 24 hours either by phone or email.<br/><br/>For urgent or rush inquiries, please Contact us Toll Free at: 1800.353.5128.<br/><br/><br/><br/></td>
    </tr>
    <tr>
        <td><strong>Thanks<br/>
