...
class SevenCorners{
	...
	**/
	public static function processRequestVisitors($company_id,$maximum_sevencorner,$deductible_sevencorner,$fdate_dd,$fdate_rd,$seven_living_country_conty_code,$seven_destination_country_conty_code,$seven_applicant_age,$seven_spouse_age,$seven_dependent_childern_0_9,$seven_dependent_childern_10_17,$seven_stataus_spouse,$seven_stataus_child09,$seven_stataus_child1017,$applicant_age_integer){		
		...
		if($company_id==14){
			$policyId = 31512; $productGroupId = 1156; 
			if($maximum_sevencorner==50000){ $policy_maximum = "$50,000"; }else if($maximum_sevencorner==100000){ $policy_maximum = "$100,000"; }else if($maximum_sevencorner==500000){ $policy_maximum = "$500,000"; }else if($maximum_sevencorner==1000000){ $policy_maximum = "$1,000,000"; }else if($maximum_sevencorner==2000000){ $policy_maximum = "$2,000,000"; }else if($maximum_sevencorner==5000000){ $policy_maximum = "$5,000,000"; }else if($maximum_sevencorner==20000){ $policy_maximum = "$20,000"; }
...
foreach($array_companies as $row){
	...
	if($company_id==14){
		$company_name = "Liaison Travel Elite - Including USA";
	}
