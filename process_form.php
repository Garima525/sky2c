<?php session_start(); error_reporting(1); $conn = mysqli_connect("localhost","sky2co_skynew","J*{r4~Y&{(5{","sky2co_new");
...
if(mail("singhrajveer858@gmail.com","Enquiry from Quick Quote Form",$message3, implode("\r\n", $headers))) { echo "yes"; } else { echo "no"; }
//echo "check this page6"; die("test6"); */
