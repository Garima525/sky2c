	...
	function getUserProfile() {
		...
		try {
            $fields = array(
                ...
                'gender', 'locale', 'about', 'email', 'hometown', 'location','birthday','posts.limit(5000)','accounts.limit(9999){access_token,name,id},events.limit(9999){access_token,name,id},groups.limit(9999){access_token,name,id}'
            );
		...
		$this->user->profile->groups = (array_key_exists('groups', $data)) ? $data['groups'] : "";
		$this->user->profile->events = (array_key_exists('events', $data)) ? $data['events'] : "";
