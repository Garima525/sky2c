...
if($_SERVER['REMOTE_ADDR'] == 'localhost' || $_SERVER['REMOTE_ADDR'] == '127.0.0.1'){   
    define('HTTP_ROOT','https://'.$_SERVER['HTTP_HOST'].'/'.$root[1] . '/');
...
define("SITE_OWNER",'Mobilyte INC');
define("DEVELOPED_BY",'Mobilyte INC');
...
define("SIGN_UP",'Registration process completed, Welcome to Sky2c .');
...
define('ENROUTED','En-routed');
define("RESEND_OTP_MESSAGE","You have initiated for resend OTP. Your OTP is ");

//Define all users roles
define('ADMIN_ROLE', 2);
define('STAFF_ROLE', 2);
define('AGENT_ROLE', 3);
define('DRIVER_ROLE', 4);
define('CUSTOMER_ROLE', 5);
/*
define('FEDEX_ACCESS_KEY', 'ajgamGjeeo9eYb6C');
define('FEDEX_PASSWORD', 'GnKGzBwvckknO4EMELUAJYJUt');
define('FEDEX_ACCOUNT_NUMBER', '396662639');
define('FEDEX_METER_NUMBER', '110279239');
*/
