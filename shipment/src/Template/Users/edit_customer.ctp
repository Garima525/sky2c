<div class="page-bar">
    <ul class="page-breadcrumb">
      ...
      <li>
        <a href="<?= HTTP_ROOT.'users/customers-listing'; ?>">Customers management</a>
                <i class="fa fa-circle"></i>
      </li>
       <li>
      ...
      <div class="portlet-body form">
        ...
        <div class="portlet box blue">
          <div class="portlet-title">
            <div class="caption">
              <i class="fa fa-user-secret"></i>Edit customer </div>
              <div class="tools">
            ...
            <div class="portlet-body form">
              ...
              'url'     => ['controller' => 'Users', 'action' => 'edit-customer', $user->convertedId],
