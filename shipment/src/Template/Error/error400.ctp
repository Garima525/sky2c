...
?>
    ...
    <div id="block_error">
        ...
        <p>
        If you want to go back on previous page, then please <a href="javascript:history.back();">click here</a> to proceed.
        If you have any questions, please contact our Technical Support department at info@sky2c.com.
        </p>
        </div>
    </div>
