...
<html lang="en">
	...
	<style>
		...
		li.green_not > a > span.time:hover {
			background: none !important;
			position: relative;
			top: 35px;
			left: 5px;
		...
		.green_not span.label-success, .green_not span.label-success:hover {
		...
		.red_not span.label-success, .red_not span.label-success:hover {
