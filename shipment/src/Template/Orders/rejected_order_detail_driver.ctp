...
<div class="page-bar">
		<ul class="page-breadcrumb">
			...
			<li>
				 <a href="<?= HTTP_ROOT.'orders/rejected-orders'; ?>">Rejected orders</a>
				<i class="fa fa-circle"></i>
			</li>
			 <li>
        ...
        <div class="portlet light bordered">   
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase">Rejected order detail</span>
                </div>
            </div>  
                    ...
                    <form role="form">
                      <div class="form-body">
                        <h4 class=" text-primary mt-0">
                          <b>ID - 
                            <span><?php if(!empty(@$order)){ echo @$order[0]['order_assignment']['order']['descrates_app_id']; }; ?>
                            </span>
                          </b>
                        </h4>
                        <hr>
                          ...
                          <div class="col-xs-12">
                            <ul class="list-inline mb-0 ">
                                     ...
                                     <li><div class="caption font-green pull-right">
                                      <a href="<?php echo HTTP_ROOT.'orders/track-order/'.@$order[0]['order_assignment']['order']['descrates_app_id']; ?>" class="icon-btn ">
