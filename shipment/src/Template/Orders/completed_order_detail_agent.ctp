...
<div class="page-bar">
		<ul class="page-breadcrumb">
			...
			<li>
				 <a href="javascript:void(0)" onClick='window.history.go(-1)' >Completed orders</a>
				<i class="fa fa-circle"></i>
			</li>
			 <li>
				<span>Completed order details</span>
			</li>
		</ul>
</div>
<!-- END PAGE HEADER-->
        ...
        <div class="portlet light bordered">   
            <div class="portlet-title">
               <div class="caption font-dark">
				...
				<h4 class="text-primary mt-0"><b>ID - <span><?php if(!empty(@$order[0]->order->descrates_app_id)){ echo @$order[0]->order->descrates_app_id; }; ?></span></b></h4>
				<ul class="list-inline mb-0 pull-right">
					<li>
						<div class="caption pull-right">
							<a href="<?php echo HTTP_ROOT.'orders/track-order/'.@$order[0]->order->descrates_app_id; ?>" class="icon-btn btn blue">
                        ...
                        <div class="row">
                          <div class="col-xs-12">
                            ...
                            <tr>
                                ...
                                <td><?= $package['order_package']['package_number']; ?></td>
                                ...
                                <td>
                                <?php 
                                if($package['order_package']['status']==1){
									echo "Open";
								}else if($package['order_package']['status']==2){
									echo "Assigned";
								}else if($package['order_package']['status']==3){
									echo "Completed";
								}else{
									echo "Completed";
								}
