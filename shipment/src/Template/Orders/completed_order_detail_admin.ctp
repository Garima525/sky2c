                  ...
                  <div class="col-md-12">
                    <form role="form">
                      <div class="form-body">
                          ...
                          <div class="col-xs-12">
                            ...
                            <tr>
                                ...
                                <td class="text-center sorting_1 bold">
                                     <?= $this->Html->link(__($package['order_package']['package_number']), ['action' => 'package-detail', base64_encode(convert_uuencode($package['order_package']['id']))],['title' => 'Packages', 'escape' => false, 'class'=> 'system_editIcon'] ) ?>
                                </td>
                        ...
                        <?php if(!empty($order[0]['order']['order_locations'])){ ?>
							<div class="ord-widget">
