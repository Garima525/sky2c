									...
									<div class="media">
										<div class="media-left title">
											<div class="col-lg-2 recordImage commentInfoHeader" data-commentid="{$COMMENT->getId()}" data-parentcommentid="{$COMMENT->get('parent_comments')}" data-relatedto = "{$COMMENT->get('related_to')}">
												...
												{else}
													<div class="name"><span><strong> {$CREATOR_NAME|escape:"html"} </strong></span></div>
												{/if}
											</div>
										</div>
											...
											<div class="comment" style="line-height:1;">
												...
												<div class="">
													...
													{if $COMMENT_CONTENT}
														...
														<span class="commentInfoContent" style="display: block" data-fullComment="{$COMMENT_CONTENT|escape:"html"}" data-shortComment="{$DISPLAYNAME|substr:0:200|escape:"html"}..." data-more='{vtranslate('LBL_SHOW_MORE',$MODULE)}' data-less='{vtranslate('LBL_SHOW',$MODULE)} {vtranslate('LBL_LESS',$MODULE)}'>
															{if $DISPLAYNAME|count_characters:true gt 200} 
																{substr(trim($DISPLAYNAME),0,200)}... 
