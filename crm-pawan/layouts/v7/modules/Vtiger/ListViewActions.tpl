        ...
        <div class = "row">
            ...
            <div class="btn-group listViewActionsContainer" role="group" aria-label="...">
                ...
                {if count($LISTVIEW_MASSACTIONS_1) gt 0 or $LISTVIEW_LINKS['LISTVIEW']|@count gt 0}
                    <div class="btn-group listViewMassActions" role="group">
                        ...
                        <ul class="dropdown-menu" role="menu">
							<li><a id="mark_as_unread" href="javascript:void(0);">Mark as Unread</a></li>
				...
				<div style="float:left;">
					<a href="javascript:void();" id="today_lead" class="btn btn-default active" style="margin-left:10px;"><i class="glyphicon glyphicon-list"></i> Today Leads</a>
					<a href="javascript:void();" id="junk_lead" class="btn btn-default active" style="margin-left:10px;"><i class="glyphicon glyphicon-trash"></i> Junk Leads</a>
					<a href="javascript:void();" id="all_lead" class="btn btn-default active" style="margin-left:10px;"><i class="glyphicon glyphicon-list"></i> All Leads</a>
				</div>
				{/if}
