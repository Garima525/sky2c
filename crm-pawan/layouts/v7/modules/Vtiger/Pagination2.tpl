...
<div class = "{$CLASS_VIEW_ACTION}">
    <div class="btn-group pull-right">
        ...
        {if $SHOWPAGEJUMP}
            ...
            <ul class="{$CLASS_VIEW_BASIC_ACTION} dropdown-menu" id="PageJumpDropDown2">
                <li>
                    ...
                    <div class="listview-pagejump">
                        <input type="text" id="pageToJump2" placeholder="Jump To" class="{$CLASS_VIEW_PAGING_INPUT} text-center"/>&nbsp;
                        <button type="button" id="pageToJumpSubmit2" class="btn btn-success {$CLASS_VIEW_PAGING_INPUT_SUBMIT} text-center">{'GO'}</button>
                    </div>    
                </li>
            </ul>
