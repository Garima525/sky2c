<?php /* Smarty version Smarty-3.1.7, created on 2018-08-21 07:00:35
         compiled from "/home/skytwocc/public_html/crm-pawan/includes/runtime/../../layouts/v7/modules/Vtiger/ListViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16110588925a546d554228c2-51501363%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c50fd9c2f4a51a00864eebe36e2ba52730daeb14' => 
    array (
      0 => '/home/skytwocc/public_html/crm-pawan/includes/runtime/../../layouts/v7/modules/Vtiger/ListViewContents.tpl',
      1 => 1534834825,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16110588925a546d554228c2-51501363',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5a546d556b64c',
  'variables' => 
  array (
    'MODULE' => 0,
...
<?php if ($_valid && !is_callable('content_5a546d556b64c')) {function content_5a546d556b64c($_smarty_tpl) {?>
...
'<?php }?> <?php if ($_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->getRaw('cf_1254')=="1"){?>style="font-weight:bold;"<?php }else{ ?><?php }?>>
...
"> <?php echo vtranslate('LBL_CREATE');?>
	...
	<div class="col-md-12" style="margin-top:25px;margin-bottom:70px;">
                ...
                <?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("Pagination2.tpl",$_smarty_tpl->tpl_vars['MODULE']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('SHOWPAGEJUMP'=>true), 0);?>
...
<script>
$("#listview-table").find('td:last-child').remove();
$(".listViewContentHeader").find('th:last-child').remove();
$(".searchRow").find('th:last-child').remove();
...
<script> 
  setTimeout(function (){
    var gets = $("#totalPageCount").text();
	$("#totalPageCount2").text(gets);	
  },9500); 
</script><?php }} ?>