<?php /* Smarty version Smarty-3.1.7, created on 2022-05-13 21:07:56
         compiled from "/home/sky2co/public_html/crm-pawan/includes/runtime/../../layouts/v7/modules/Settings/Leads/LeadMappingEdit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1930487321627ec8ace13b39-61002506%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dcdb8e3b91ec1c6af241e3f4aef81d38da211dbf' => 
    array (
      0 => '/home/sky2co/public_html/crm-pawan/includes/runtime/../../layouts/v7/modules/Settings/Leads/LeadMappingEdit.tpl',
      1 => 1560287222,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1930487321627ec8ace13b39-61002506',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_627ec8acebf33',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_627ec8acebf33')) {function content_627ec8acebf33($_smarty_tpl) {?>
...
" value="<?php echo $_smarty_tpl->tpl_vars['FIELD_ID']->value;?>
"><?php echo vtranslate($_smarty_tpl->tpl_vars['FIELD_OBJECT']->value->get('label'),$_smarty_tpl->tpl_vars['POTENTIALS_MODULE_MODEL']->value->getName());?>
</option><?php } ?><?php } ?></select></td></tr></tbody></table><div class="row"><span class="col-sm-4"><button id="addMapping" class="btn addButton module-buttons" type="button"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo vtranslate('LBL_ADD_MAPPING',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</button></span><span class="col-sm-8"><span class="pull-right"><button type="submit" class="btn btn-success"><strong><?php echo vtranslate('LBL_SAVE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</strong></button><a class="cancelLink" type="reset" href="<?php echo $_smarty_tpl->tpl_vars['MODULE_MODEL']->value->getDetailViewUrl();?>
">Cancel</a></span></span></div></div></div></form></div></div></div><?php }} ?>