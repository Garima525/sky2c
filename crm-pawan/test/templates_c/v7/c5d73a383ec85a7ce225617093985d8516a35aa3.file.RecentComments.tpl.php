<?php /* Smarty version Smarty-3.1.7, created on 2018-02-02 09:38:55
         compiled from "/home/skytwocc/public_html/crm-pawan/includes/runtime/../../layouts/v7/modules/Vtiger/RecentComments.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2741177315a602a8ba46bb6-20516450%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c5d73a383ec85a7ce225617093985d8516a35aa3' => 
    array (
      0 => '/home/skytwocc/public_html/crm-pawan/includes/runtime/../../layouts/v7/modules/Vtiger/RecentComments.tpl',
      1 => 1517564299,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2741177315a602a8ba46bb6-20516450',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5a602a8bc59d9',
  'variables' => 
  array (
...
<?php if ($_valid && !is_callable('content_5a602a8bc59d9')) {function content_5a602a8bc59d9($_smarty_tpl) {?>
...
" width="40px" height="40px" align="left"><?php }else{ ?><div class="name"><span><strong> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['CREATOR_NAME']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
...
<?php $_tmp4=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['DISPLAYNAME'] = new Smarty_variable($_tmp4, null, 0);?><span class="commentInfoContent" style="display: block" data-fullComment="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['COMMENT_CONTENT']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
" data-shortComment="<?php echo htmlspecialchars(substr($_smarty_tpl->tpl_vars['DISPLAYNAME']->value,0,200), ENT_QUOTES, 'ISO-8859-1', true);?>
...
'><?php if (strlen($_smarty_tpl->tpl_vars['DISPLAYNAME']->value)>200){?><?php echo substr(trim($_smarty_tpl->tpl_vars['DISPLAYNAME']->value),0,200);?>
...
$(".showMore").click(function(){
	var curSpan = $(this).parent('span').attr('data-fullcomment');		
	$(this).parent('span').html(curSpan+'<a class="pull-right toggleComment showLess" onclick="callthisLess();"><small>Show Less</small></a>');	
});

function callthisLess(){
$(".showLess").live('click',function(){
	var curSpan = $(this).parent('span').attr('data-shortcomment');
	$(this).parent('span').html(curSpan+'<a onclick="callthisMore();" class="pull-right toggleComment showMore"><small>Show More</small></a>');
});
}


function callthisMore(){
