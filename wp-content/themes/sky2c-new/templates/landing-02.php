...
if($deduct_browser_header=="No"){ ?>
		...
		<video id="mainvideo" class="video-js vjs-default-skin" preload controls muted loop >
...
<?php }?>
		...
		<div class="video-text">
			...
			<div class="btn-section">
				<a class="btn btn-blue" href=""> View More </a>
			</div>
		</div>
...
<?php /* form section starts here */ ?>
<div id="request-section">
	<div id="request-quote">
		<div class="landing-quote-form1">
			<h2>Quick Quotes</h2>
			<p>Fill out the form to have an expert give you custom quotes or <strong>Call us at <a href="tel:+18003535128">+1.800.353.5128</a></strong></p>
			<div class="landing-quote-form-content1">
				<form method="post" action="" class="landingquote-form1">
					
					<div class="row landingquote-form1-content">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 landingquote-form1-text">
							<h5>Enter the Zip or Postal code</h5>
						</div>
					   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group">
								<input type="text" name="FromZip" id="FromZip" class="form-control" placeholder=" ">
								<label for="FromZip">From Zip*</label>
							</div>
					   </div>
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group">
								<input type="text" name="ToZip" id="ToZip" class="form-control" placeholder=" ">
								<label for="ToZip">To Zip*</label>
							</div>						   
						</div>
					</div>
					...
					<div class="row landingquote-form1-content">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 landingquote-form1-text">
							<h5>Enter the Country</h5>
						</div>
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group">
								<select name="Fromcountry" id="Fromcountry" class="country form-control designer-select"> 
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group">
								<select name="Tocountry" id="Tocountry" class="country form-control designer-select"> 
					   ...
					   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group">
								<input type="text" name="EmailAddress" id="EmailAddress" class="form-control" placeholder=" ">
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group">
								...
								<label for="CellPhone">Your Phone*</label>
							</div>						   
						</div>
					</div>
					...
					<div class="row landingquote-form1-content">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 landingquote-form1-text">
							<h5>Describe your shipment</h5>
						</div>
                        
					   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group">
								<textarea name="Comments" id="Comments" type="textarea" cols="" rows="3" class="shipment form-control" placeholder=" "></textarea>
								<label for="Comments">Message...</label>
							</div>
					   </div>
                       <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group" id="grecaptcha">
								<div class="g-recaptcha" data-sitekey="6LfvCLIUAAAAANLDvZQUEjD0zymJM5v-hKGkoJ0X"></div>
							</div>						   
						</div>
					</div>
					...
					<div class="row landingquote-form1-content">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="btn-section">
								<input id="btnSubmit" class="btn btn-default btn-blue" type='button' style="cursor:pointer;" onclick="checkbtnclick();" name="btnSubmit" value="Submit" onClick="_gaq.push(['_trackEvent', 'home', 'submit',,, false]);" />
							</div>
						</div>
					</div>
	...
	<div id="request-tab">
		<span class="quote-request-tab">Get a <span>Quote</span></span>
	</div>
</div>
<?php /* form section ends here */ ?>
