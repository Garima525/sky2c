...
<div id="primary" class="content-area thanks-pg-content clr">
	<div id="content" class="site-content innerpages" role="main">
		<?php while ( have_posts() ) : the_post(); ?>
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				<div class="entry clr">
					<div class="container">
						<div class="row thanks-pg-title">
						...
						<div class="row">
							<div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-offset-2 col-sm-8 col-xs-12 thanks-pg-text">
								<?php the_content(); ?>
							</div>
						</div>
