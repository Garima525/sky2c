...
// ----------------- Content Slider main class ---------------------------
	...
	content_slider.prototype = {
		...
		_create_arrows : function () {
			...
			if (this.options.hv_switch) {
				if (this.options.border_on_off==0 || this.options.use_thin_arrows==1) {
					html = '<div class="circle_slider_nav_left"><img src="images/left_vertical2.png" alt="left" /></div>';
					html += '<div class="circle_slider_nav_right"><img src="images/right_vertical2.png" alt="right" /></div>';
				} else {
					html = '<div class="circle_slider_nav_left"><img src="images/left_vertical.png" alt="left" /></div>';
					html += '<div class="circle_slider_nav_right"><img src="images/right_vertical.png" alt="right" /></div>';
				}
			} else {
				if (this.options.border_on_off==0 || this.options.use_thin_arrows==1) {
					html = '<div class="circle_slider_nav_left"><img src="images/left2.png" alt="left" /></div>';
					html += '<div class="circle_slider_nav_right"><img src="images/right2.png" alt="right" /></div>';
				} else {
					html = '<div class="circle_slider_nav_left"><img src="images/left.png" alt="left" /></div>';
					html += '<div class="circle_slider_nav_right"><img src="images/right.png" alt="right" /></div>';
				}
			}
			return html;
		},
